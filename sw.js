...
self.addEventListener('fetch', e => {
  // ΚΡΙΣΙΜΟ (iOS): μόνο GET περνάει από τον SW. Σε POST/PUT/PATCH/DELETE το
  // iOS Safari χάνει το multipart body όταν γίνεται fetch(e.request) — π.χ.
  // uploads στο Cloudinary έφταναν χωρίς upload_preset. Τα αφήνουμε να πάνε
  // κατευθείαν στο δίκτυο, χωρίς καμία παρέμβαση.
