...
// ⚠️ ΣΗΜΑΝΤΙΚΟ: σε ΚΑΘΕ νέα έκδοση της εφαρμογής, ανέβασε τον αριθμό (v4 → v5 → v6 …).
// Αυτό κάνει τον browser να δει «νέα έκδοση» και να εμφανίσει το toast «Ανανέωση»
// στους συνεργάτες — χωρίς χειροκίνητο καθάρισμα cache ή επανεγκατάσταση.
